...
@Service
public class RoundRobinTeamsService {
    ...
    public List<Match> generateMatches(List<Team> teams, String leagueId, MatchType matchType) {
        ...
        List<RoundRobinTeamsService.Pair> pairs = new ArrayList<>();
        ...
        for (int round = 0; round < rounds; round++) {
            ...
            for (int i = 0; i < halfSize; i++) {
                ...
                pairs.add(new RoundRobinTeamsService.Pair(t1, t2, round + 1));
            }
    ...
    private boolean assignHomeAway(int index, List<RoundRobinTeamsService.Pair> pairs,
        ...
        RoundRobinTeamsService.Pair pair = pairs.get(index);
        Team t1 = pair.t1;
        Team t2 = pair.t2;
